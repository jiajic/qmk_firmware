...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_LAYER0] = LAYOUT_all(
        ...
        KC_LCTL, KC_NO,   KC_LGUI,                            SPC_FN1,                            KC_RALT, MO(2),   KC_NO,   MO(3)
    ),
    ...
    [_LAYER1] = LAYOUT_all( // Navigation Layer
        ...
        KC_TRNS, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_10,   KC_MINS, KC_EQU,  KC_BSPC,
        KC_TRNS, KC_NO,   KC_NO,   KC_LBRC, KC_RBRC, KC_NO,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_QUOT, KC_NO,            KC_TRNS,
        KC_TRNS, KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   NK_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_TRNS, KC_TRNS,
        KC_TRNS, KC_TRNS, KC_TRNS,                            KC_TRNS,                            KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS
    ),

    [_LAYER2] = LAYOUT_all( // Symbols Layer
        KC_TRNS, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_10,   KC_F11,  KC_F12,  KC_TRNS, KC_TRNS,
        KC_EXLM, KC_AMPR, KC_BSLS, KC_GRV,  KC_PERC, KC_RABK, KC_TRNS, KC_PMNS, KC_PLUS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
        KC_HASH, KC_AT,   KC_DLR,  KC_LCBR, KC_RCBR, KC_UNDS, KC_PEQL, ARIN,    SCOPE,   UPDIR,   KC_TRNS, KC_NO,            KC_TRNS,
